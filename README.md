Creatve Technology Department of Team One LA.
============

This is a [Jekyll](http://jekyllrb.com/) port of the [Solid theme](http://www.blacktie.co/2014/05/solid-multipurpose-theme/) by [blacktie.co](http://www.blacktie.co/). Visit the [live demo](https://st4ple.github.io/solid-jekyll/) for a preview. This theme has been modified to outfit the look and feel for the CT group.

install the jekyll by going to the terminal and type $ gem install jekyll.
Clone this repo
